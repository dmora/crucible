...
type ModelItem struct {
	prov      config.ProviderMetadata
	model     config.ModelMetadata
	modelType ModelType
...
func NewModelItem(t *styles.Styles, prov config.ProviderMetadata, model config.ModelMetadata, typ ModelType, showProvider bool) *ModelItem {
	return &ModelItem{
		prov:         prov,
		model:        model,
		modelType:    typ,
