...
func init() {
	...
	os.Unsetenv("CRUCIBLE_GLOBAL_CONFIG")
	os.Unsetenv("CRUCIBLE_GLOBAL_DATA")
}
...
func TestDirs(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakeconfig/crucible") + "\n" +
		filepath.FromSlash("/tmp/fakedata/crucible") + "\n"
...
func TestDataDir(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakedata/crucible") + "\n"
	require.Equal(t, expected, b.String())
}
